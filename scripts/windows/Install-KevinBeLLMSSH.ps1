...
if ($MachineAPort -lt 1 -or $MachineAPort -gt 65535) {
...
Write-Host "Installed idempotent SSH alias kevinbellm-a in $configPath"
...
if ($InstallPublicKey) {
    ...
    Write-Host "Public key installed. Test: ssh kevinbellm-a"
} else {
